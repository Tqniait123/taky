...
import '../../features/office_boy/data/models/office_user_model.dart';

class OfficeBoyNotificationBottomSheet extends StatefulWidget {
  final OfficeOrganization organization;
  final String userId;
  final UserRole userRole;
  final VoidCallback? onNotificationsUpdated;

  const OfficeBoyNotificationBottomSheet({
    super.key,
  ...
  @override
  State<OfficeBoyNotificationBottomSheet> createState() =>
      _OfficeBoyNotificationBottomSheetState();
}

class _OfficeBoyNotificationBottomSheetState
    extends State<OfficeBoyNotificationBottomSheet>
